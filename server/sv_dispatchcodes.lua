...
dispatchCodes = {
	...
	["civdown"] =  {displayCode = '10-69', description = "Civilan Down", radius = 0, recipientList = {'police', 'ambulance'}, blipSprite = 126, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "dispatch", offset = "false", blipflash = "false"},
	["civdead"] =  {displayCode = '10-69', description = "Civilan Bled Out", radius = 0, recipientList = {'police', 'ambulance'}, blipSprite = 310, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "dispatch", offset = "false", blipflash = "false"},
