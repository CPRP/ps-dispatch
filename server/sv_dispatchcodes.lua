...
dispatchCodes = {
	...
	["speeding"] =  {displayCode = '10-13', description = "Speeding", radius = 0, recipientList = {'police'}, blipSprite = 326, blipColour = 84, blipScale = 1.5, blipLength = 1, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false", blipflash = "false"},
	["fight"] =  {displayCode = '10-10', description = "Fight In Progress", radius = 0, recipientList = {'police'}, blipSprite = 685, blipColour = 69, blipScale = 1.5, blipLength = 1, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "false", blipflash = "false"},
	["civdown"] =  {displayCode = '10-69', description = "Civilan Down", radius = 0, recipientList = {'police', 'ambulance'}, blipSprite = 126, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "dispatch", offset = "false", blipflash = "false"},
	["civdead"] =  {displayCode = '10-69', description = "Civilan Bled Out", radius = 0, recipientList = {'police', 'ambulance'}, blipSprite = 126, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "dispatch", offset = "false", blipflash = "false"},
	...
	["suspiciousactivity"] =  {displayCode = '10-17', description = "Suspicious Activity", radius = 120.0, recipientList = {'police'}, blipSprite = 456, blipColour = 1, blipScale = 0, blipLength = 1.5, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset", offset = "true"},
	...
	["civdead"] =  {displayCode = '10-69', description = "Civilan Bled Out", radius = 0, recipientList = {'police', 'ambulance'}, blipSprite = 126, blipColour = 3, blipScale = 1.5, blipLength = 2, sound = "dispatch"},
